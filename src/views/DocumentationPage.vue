...
export default {
  ...
  data () {
    return {
      API_URL: `${import.meta.env.VUE_APP_ELASTICSEARCH_URL}`,
      DTS_URL: `${import.meta.env.VUE_APP_API_URL}`,
      IIIF_SERVER_URL: `${import.meta.env.VUE_APP_IIIF_SERVER_URL}`,
      IIIF_URL: `${import.meta.env.VUE_APP_IIIF_URL}`,
      IIIF_IMAGES_URL: `${import.meta.env.VUE_APP_IIIF_IMAGES_URL}`,
      isMenuOpened: false
    }
  },
  computed: {
